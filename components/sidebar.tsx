...
const loadVariantColorForLogo = () => {
  return {
    hidden: {
      opacity: 0,
      pathLength: 0,
      fill: "rgb(" + loadColorForLogo() + ", 0)"
    },
    visible: {
      opacity: 1,
      pathLength: 1,
      fill: "rgb(" + loadColorForLogo() + ", 1)"
    }
  }
};
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  return (
    <Box
      ...
      {...rest}>
      <Flex mx="8" mt="8" justifyContent="space-between">
      ...
      <Flex position="fixed" bottom="0" mx="8" mb="12" justifyContent="flex-end" gap={4}>
        <Box w="10" h="10">
          <Text color={logoColor}>And here</Text>
        </Box>
        <Box w="10" h="10">
          <motion.svg
            xmlns="http://www.w3.org/2000/svg"
