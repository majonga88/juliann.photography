...
import { NavItem } from '@/component/SideMenu/NavItem/NavItem';
import { MobileNav } from '@/component/SideMenu/MobileNav/MobileNav';
  ...
  return (
    <Box minH="100vh" bg={loadBackgroundColor} color={loadColor}>
      ...
      <MobileNav display={{ base: 'flex', md: 'none' }} width={{
        base: '100%',
        sm: '80%',
      }} justifyContent={'space-between'} bg={loadBackgroundColor} onOpen={onOpen} logoColor={logoColor} logoVariantColor={logoVariantColor} />
