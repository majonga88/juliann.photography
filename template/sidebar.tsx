...
const LinkItems: Array<LinkItemProps> = [
  { name: 'Bookstore (Soon)', path: '/about' },
  { name: 'Printstore (Soon)', path: '/about' },
];
...
export default function SimpleSidebar({ children }: { children: ReactNode }) {
  ...
  return (
    <Box minH="100vh" bg={loadBackgroundColor} color={loadColor}>
      ...
      {/* mobilenav */}
      <MobileNav display={{ base: 'flex', md: 'none' }} bg={loadBackgroundColor} onOpen={onOpen} />
    ...
    <Box
      ...
      <Flex mx="8" mt="8" justifyContent="space-between" h={'17vh'}>
        <Link href='/' style={{ textDecoration: 'none' }} _focus={{ boxShadow: 'none' }} >
          ...
          >
            <motion.path
              d="M 189.933 36.465 L 189.933 58.48 L 185.003 58.48 L 185.003 37.613 Q 185.003 34.144 184.037 31.829 A 7.51 7.51 0 0 0 182.283 29.219 Q 179.563 26.648 175.313 26.648 A 9.919 9.919 0 0 0 170.715 27.797 A 12.177 12.177 0 0 0 169.894 28.262 A 12.745 12.745 0 0 0 165.815 32.337 A 14.893 14.893 0 0 0 165.601 32.682 Q 163.923 35.488 163.923 38.973 L 163.923 58.48 L 159.078 58.48 L 159.078 23.588 L 163.923 23.588 L 163.923 30.303 Q 164.208 28.875 165.805 27.154 A 14.909 14.909 0 0 1 165.941 27.009 A 13.545 13.545 0 0 1 168.187 25.131 A 18.04 18.04 0 0 1 170.361 23.885 A 13.165 13.165 0 0 1 175.95 22.57 A 15.261 15.261 0 0 1 176.248 22.567 Q 179.563 22.568 182.708 23.991 Q 185.853 25.415 187.893 28.496 Q 189.713 31.246 189.909 35.434 A 22.067 22.067 0 0 1 189.933 36.465 Z M 42.118 23.588 L 42.118 41.82 Q 42.118 46.434 43.651 49.611 A 11.538 11.538 0 0 0 44.816 51.531 A 8.706 8.706 0 0 0 50.249 54.867 A 13.578 13.578 0 0 0 52.955 55.122 A 13.238 13.238 0 0 0 56.179 54.754 A 8.543 8.543 0 0 0 61.115 51.531 A 12.543 12.543 0 0 0 63.102 47.384 Q 63.793 44.928 63.793 41.82 L 63.793 23.588 L 68.638 23.588 L 68.638 42.67 A 22.305 22.305 0 0 1 68.152 47.422 A 17.807 17.807 0 0 1 66.81 51.361 A 14.022 14.022 0 0 1 61.498 57.332 A 13.955 13.955 0 0 1 56.839 59.135 A 19.657 19.657 0 0 1 52.955 59.5 A 19.315 19.315 0 0 1 48.996 59.114 A 13.916 13.916 0 0 1 44.455 57.332 Q 40.97 55.165 39.143 51.361 Q 37.315 47.558 37.315 42.67 L 37.315 23.588 L 42.118 23.588 Z M 27.37 2.38 L 27.37 41.523 Q 27.37 46.555 26.083 50.354 A 19.385 19.385 0 0 1 25.819 51.085 A 14.114 14.114 0 0 1 23.773 54.757 A 12.026 12.026 0 0 1 21.038 57.311 A 12.075 
54.668 A 11.766 11.766 0 0 0 136.978 53.508 Q 139.868 51.765 141.546 48.578 A 14.231 14.231 0 0 0 142.948 44.388 A 19.189 19.189 0 0 0 143.225 41.055 A 18.872 18.872 0 0 0 142.88 37.362 A 14.075 14.075 0 0 0 141.546 33.533 A 12.857 12.857 0 0 0 138.665 29.823 A 12.078 12.078 0 0 0 136.978 28.581 A 12.119 12.119 0 0 0 131.414 26.852 A 14.829 14.829 0 0 0 130.39 26.817 A 12.789 12.789 0 0 0 123.994 28.539 A 13.373 13.373 0 0 0 119.286 33.055 A 15.799 15.799 0 0 0 119.042 33.447 A 13.202 13.202 0 0 0 117.377 38.037 A 17.71 17.71 0 0 0 117.13 41.055 Z M 102.425 58.48 L 97.623 58.48 L 97.623 23.588 L 102.425 23.588 L 102.425 58.48 Z M 206.078 59.018 A 4.677 4.677 0 0 0 208.208 59.5 A 5.651 5.651 0 0 0 208.27 59.5 A 4.624 4.624 0 0 0 211.608 58.098 A 5.653 5.653 0 0 0 211.651 58.054 A 4.574 4.574 0 0 0 213.01 54.74 Q 213.01 52.7 211.608 51.298 A 5.534 5.534 0 0 0 211.564 51.254 A 4.625 4.625 0 0 0 208.208 49.895 Q 206.21 49.895 204.829 51.298 A 4.741 4.741 0 0 0 203.837 52.752 A 4.966 4.966 0 0 0 203.448 54.74 A 5.51 5.51 0 0 0 203.448 54.771 A 4.614 4.614 0 0 0 204.829 58.098 A 4.732 4.732 0 0 0 206.078 59.018 Z M 97.508 8.385 A 3.558 3.558 0 0 0 100.088 9.435 Q 101.66 9.435 102.786 8.351 A 4.366 4.366 0 0 0 102.856 8.283 A 3.484 3.484 0 0 0 103.913 5.737 Q 103.913 4.675 103.381 3.846 A 4.097 4.097 0 0 0 101.979 2.508 Q 101.108 1.998 100.088 1.998 A 3.584 3.584 0 0 0 98.757 2.244 A 3.791 3.791 0 0 0 97.495 3.081 Q 96.39 4.165 96.39 5.737 A 4.294 4.294 0 0 0 96.39 5.785 A 3.558 3.558 0 0 0 97.474 8.351 A 4.312 4.312 0 0 0 97.508 8.385 Z"
        ...
        <CloseButton display={{ base: 'flex', md: 'none' }} bg={color} onClick={onClose} />
      </Flex>
      {LinkItems.map((link) => (
        <NavItem key={link.name} path={link.path} fontSize="2.5rem" fontWeight="300">
          {link.name}
        </NavItem>
      ))}
      <Flex position="fixed" bottom="0" mx="8" mb="12" justifyContent="flex-end" gap={4}>
        <Box w="10" h="10">
          <motion.svg
            xmlns="http://www.w3.org/2000/svg"
          >
...
const NavItem = ({ path, children, ...rest }: NavItemProps) => {
  ...
  return (
    <Link href={path} style={{ textDecoration: 'none' }} _focus={{ boxShadow: 'none' }} color={loadColor}>
      <Flex
        align="center"
        mx="8"
        role="group"
